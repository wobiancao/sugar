...
public class ImageLoaderManager {
     ...
     *  内部只需要获取Context
     */
    public static ImageLoaderOptions getDefaultOptions(@androidx.annotation.NonNull View container, @androidx.annotation.NonNull String url){
    ...
    public void showImage(@androidx.annotation.NonNull ImageLoaderOptions options, LoaderEnum loaderEnum) {
        if (getLoaderstrategy(loaderEnum) != null) {
            getLoaderstrategy(loaderEnum).showImage(options);
        }
    }

    public void hideImage(@androidx.annotation.NonNull View view, int visiable) {
        if (getLoaderstrategy(curLoader) != null) {
