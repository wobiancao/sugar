...
public class FrescoImageLoader implements IImageLoaderstrategy {
    ...
    @Override
    public void showImage(@androidx.annotation.NonNull ImageLoaderOptions options)   {
        showImgae(options);
    }

    @Override
    public void hideImage(@androidx.annotation.NonNull View view, int isVisiable) {
    ...
    private void showImgae(final ImageLoaderOptions options) {
        ...
        if (options.needImageRadius()) {
            if (options.isAllRadius()){
                ...
                RoundingParams roundingParams = RoundingParams.fromCornersRadii(options.getTopLeftRadius(), options.getTopRightRadius(),
                        options.getBottomLeftRadius(), options.getBottomRightRadius());
                hierarchyBuilder.setRoundingParams(roundingParams);
            }
        ...
        if (options.getLoaderResultCallBack() != null) {
            controllerBuilder.setControllerListener(new ControllerListener<ImageInfo>() {
                ...
                @Override
                public void onFinalImageSet(String id, @androidx.annotation.Nullable ImageInfo imageInfo, @androidx.annotation.Nullable Animatable animatable) {
                ...
                @Override
                public void onIntermediateImageSet(String id, @androidx.annotation.Nullable ImageInfo imageInfo) {
