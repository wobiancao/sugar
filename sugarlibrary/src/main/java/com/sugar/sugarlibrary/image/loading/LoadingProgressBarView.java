package com.sugar.sugarlibrary.image.loading;
...
public class LoadingProgressBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.lib_LoadingProgressBarView);
        final Resources res = getResources();

        mMax = a.getInteger(R.styleable.lib_LoadingProgressBarView_ppvMax, mMax);
        mProgress = a.getInteger(R.styleable.lib_LoadingProgressBarView_ppvProgress, mProgress);
        mStartAngle = a.getInt(R.styleable.lib_LoadingProgressBarView_ppvStartAngle, mStartAngle);
        mInverted = a.getBoolean(R.styleable.lib_LoadingProgressBarView_ppvInverted, mInverted);
        mCounterclockwise = a.getBoolean(R.styleable.lib_LoadingProgressBarView_ppvCounterclockwise, mCounterclockwise);
        mStrokeWidth = a.getDimension(R.styleable.lib_LoadingProgressBarView_ppvStrokeWidth, mStrokeWidth);
        mTypeface = a.getString(R.styleable.lib_LoadingProgressBarView_ppvTypeface);
        mTextSize = a.getDimension(R.styleable.lib_LoadingProgressBarView_android_textSize, mTextSize);
        mText = a.getString(R.styleable.lib_LoadingProgressBarView_android_text);

        mShowStroke = a.getBoolean(R.styleable.lib_LoadingProgressBarView_ppvShowStroke, mShowStroke);
        mShowText = a.getBoolean(R.styleable.lib_LoadingProgressBarView_ppvShowText, mShowText);
        mImage = a.getDrawable(R.styleable.lib_LoadingProgressBarView_ppvImage);

        int backgroundColor = res.getColor(R.color.libColorTrans);
        backgroundColor = a.getColor(R.styleable.lib_LoadingProgressBarView_ppvBackgroundColor, backgroundColor);
        int progressColor = res.getColor(R.color.libColorProgress);
        progressColor = a.getColor(R.styleable.lib_LoadingProgressBarView_ppvProgressColor, progressColor);
        int strokeColor = res.getColor(R.color.libColorProgressStroke);
        strokeColor = a.getColor(R.styleable.lib_LoadingProgressBarView_ppvStrokeColor, strokeColor);
        int textColor = res.getColor(R.color.libColorProgressText);
        textColor = a.getColor(R.styleable.lib_LoadingProgressBarView_android_textColor, textColor);

        mProgressFillType = a.getInteger(R.styleable.lib_LoadingProgressBarView_ppvProgress_FillType, mProgressFillType);
